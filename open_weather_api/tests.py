...
class WeatherDataViewTestCase(TestCase):
    ...
    def test_missing_user_defined_id(self):
        ...
        self.assertEqual(response_content, {"message": "User ID is required.", "status": "error"})
    ...
    def test_invalid_json_body(self):
        ...
        self.assertEqual(response.status_code, 400)
        response_content = json.loads(response.content)
        self.assertEqual(response_content, {"status": "error", "message": "Invalid JSON format"})
    ...
    def test_existing_user_id(self, mock_filter):
        ...
        self.assertEqual(response.status_code, 400)
        response_content = json.loads(response.content)
        self.assertEqual(response_content, {"Error": "This user ID is already in use."})
